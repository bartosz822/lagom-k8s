...
sealed trait Accepted extends Confirmation with Serializable
...
object HelloSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    ...
    JsonSerializer[com.example.hello.impl.HelloState],
    // the replies use play-json as well
    JsonSerializer[Greeting],
    JsonSerializer[Confirmation],
    JsonSerializer[Accepted],
    JsonSerializer[com.example.hello.impl.Accepted],
